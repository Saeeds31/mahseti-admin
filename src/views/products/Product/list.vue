              ...
              <tr v-for="product in products.data" :key="product.id">
                ...
                <td>
                  <span :class="product.status == 'published' ? 'badge bg-success' : 'badge bg-secondary'">
                    {{ product.status == 'published' ? 'موجود' : product.status == 'unpublished' ? 'ناموجود' :
                      product.published_at ? `انتشار در تاریخ ${new
                        Date(product.published_at).toLocaleString('fa-IR')}` : 'پیش نویس'
                    }}
                  </span>
                </td>
                <td>

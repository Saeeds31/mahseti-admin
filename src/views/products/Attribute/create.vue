<template>
  <div class="container py-4" v-if="checkPermission(['attributes_store'])">
    <b-card>
      <h5 class="mb-3">ایجاد ویژگی</h5>
      <b-form @submit.prevent="handleSubmit">
        ...
        <div class="mt-3">
          <b-button :disabled="loading" type="submit" variant="primary">ثبت</b-button>
        </div>
      </b-form>
    </b-card>
  </div>
